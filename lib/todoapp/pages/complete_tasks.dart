...
class CompleteTasksPage extends StatelessWidget{
   Function updateFun;
  Function deletFun;
    CompleteTasksPage(this.deletFun,this.updateFun);
...
return ListView.builder(
  itemCount: Data.tasks.where((element) => element.isComplete).length,
    ...
    return TaskItem (Data.tasks.where((element) => element.isComplete).toList()[index],deletFun: deletFun,updateFun: updateFun,);
  });
  }
